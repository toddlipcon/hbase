...
public class HBaseTest
{
  ...
  public void loadData() {
    ...
    // start the writers
    MultiThreadedWriter writer = new MultiThreadedWriter(tableName_, columnFamilies_[0]);
...
//    writer.waitForFinish();
  ...
  public void readData() {
    ...
    // start the readers
    MultiThreadedReader reader = new MultiThreadedReader(tableName_, columnFamilies_[0]);
