...
public class HRegion implements HeapSize { // , Writable{
  ...
  throws IOException {
    ...
    MonitoredTask status = StatusMonitor.get().createStatus(
  ...
  public boolean flushcache() throws IOException {
    ...
    MonitoredTask status = StatusMonitor.get().createStatus("Flushing " + this);
  ...
  private long replayRecoveredEdits(final Path edits,
    ...
    LOG.info(msg);
    MonitoredTask status = StatusMonitor.get().createStatus(msg);
